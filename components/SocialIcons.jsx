...
export default function SocialIcons() {
  return (
    ...
    <div className='flex gap-6 pr-4 animate-bounce'>
        ...
        <Link href={''} className='text-[#08d9d6] text-2xl hover:translate-y-2 transition-all duration-500'><RiYoutubeFill/></Link>
        <Link href={''} className='text-[#f08a5d] text-2xl hover:translate-y-2 transition-all duration-500'><RiInstagramFill/></Link>
        <Link href={''} className='text-[#ff2e63] text-2xl hover:translate-y-2 transition-all duration-500'><RiTwitterFill/></Link>
        <Link href={''} className='text-[#0a66c2] text-2xl hover:translate-y-2 transition-all duration-500'><RiLinkedinFill/></Link>
